...
export class IntegrationInventoryAttributeChangeConfirmationService {
  constructor(private http: _HttpClient, 
    ...
    getData(startTime?: Date, endTime?:Date, date?: Date, statusList?: string, id?: number): Observable<IntegrationInventoryAttributeChangeConfirmation[]> {
      let url = `integration/integration-data/inventory-attribute-change-confirmations?warehouseId=${this.warehouseService.getCurrentWarehouse().id}`;
