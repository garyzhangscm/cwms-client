...
export class IntegrationClientDataService {
  ...
  getData(startTime?: Date, endTime?:Date, date?: Date, statusList?: string): Observable<IntegrationClientData[]> {
  ...
  resend(id: number) : Observable<IntegrationClientData> {
    let url = `integration/integration-data/clients/${id}/resend`;
