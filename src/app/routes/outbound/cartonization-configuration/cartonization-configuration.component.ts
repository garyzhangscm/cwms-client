...
export class OutboundCartonizationConfigurationComponent implements OnInit {
  ...
  sort(sort: { key: string; value: string }): void {
    ...
    if (this.sortKey && this.sortValue) {
      this.listOfDisplayCartonizationConfiguration = this.listOfAllCartonizationConfiguration.sort((a, b) =>
      ...
      this.listOfDisplayCartonizationConfiguration = this.listOfAllCartonizationConfiguration;
    }
  }

  change(cartonizationConfiguration: CartonizationConfiguration) {
