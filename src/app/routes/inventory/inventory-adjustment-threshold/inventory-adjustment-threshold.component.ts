...
export class InventoryInventoryAdjustmentThresholdComponent implements OnInit {
  ...
  sort(sort: { key: string; value: string }): void {
    ...
    if (this.sortKey && this.sortValue) {
      this.listOfDisplayInventoryAdjustmentThresholds = this.listOfAllInventoryAdjustmentThresholds.sort((a, b) =>
      ...
      this.listOfDisplayInventoryAdjustmentThresholds = this.listOfAllInventoryAdjustmentThresholds;
    }
  }
