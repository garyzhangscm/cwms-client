...
export class IntegrationItemUnitOfMeasureDataService {
  ...
  constructor(private http: _HttpClient, 
    ...
    getData(startTime?: Date, endTime?:Date, date?: Date, statusList?: string, id?: number, warehouseName?: string): Observable<IntegrationItemUnitOfMeasureData[]> {
      let url = `integration/integration-data/item-unit-of-measures?companyCode=${this.companyService.getCurrentCompany()?.code}`;
